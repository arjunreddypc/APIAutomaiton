...
public class AgentAssistAutomation {
	...
	public static void invokeBotController() {
		try {
			...
			for(int i=0 ; i < inputMessages.size() ; i++) {
				...
				String URL = "https://dev2-apiservices-web.dev.sprint.com:7441/api/digital/aiva/v1/virtual-agent-controller/controller/agent";
				...
				//	JsonObject jsonObject = new JsonObject();
					...
					for(int j = 0; j < discoveryText.length() ; j++){
						System.out.println(discoveryText.get(i));
					}
					String discoveryResponse = getJsonValue(res,"passageText").equals(null) ? "" : getJsonValue(res,"passageText").toString();
	...
	public static void prepareHeaders() {
		...
		outputDetails.put("Engagement Id", Arrays.asList("Agent Id", "Input text", "Passage text"));
	}
